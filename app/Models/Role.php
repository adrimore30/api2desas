...
{
    //campo el caula lleva asignacion masiva
    protected $fillable = ['name_role'];
    // listas blancas
    Protected $allowIncluded = ['profiles' ,'profiles.user'];
    Protected $allowFilter = ['id', 'name_role'];
    Protected $alloSort = ['id', 'name_role'];
    ...
    public function scopeGetOrPaginate(Builder $query)
    {
      if (request('perPage')) {
        ...
        //http://api.codersfree1.test/v1/role?perPage=2
}
}